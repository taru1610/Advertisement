...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { Company_name: @advertisement.Company_name, description: @advertisement.description, email: @advertisement.email, phone: @advertisement.phone, title: @advertisement.title } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { Company_name: @advertisement.Company_name, description: @advertisement.description, email: @advertisement.email, phone: @advertisement.phone, title: @advertisement.title } }
